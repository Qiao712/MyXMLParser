...
namespace QSimpleXMLParser{
    ...
    enum XMLParseError {
        ...
        XML_PARSE_ERROR_UNPAIRED_TAG,      //Unpaired tag δ��Եı�ǩ
        XML_PARSE_ERROR_WRONG_END_TAG,     //wrong end tag ����Ľ�����ǩ
        XML_PARSE_ERROR_UNCLOSED_PARENTHESE,  //Unclosed parenthese δ��յ����� <....
        XML_PARSE_ERROR_INVALID_TAG_NAME,      //Invalid tag name ��Ч�ı�ǩ��

        XML_PARSE_ERROR_ATTR,
        XML_PARSE_ERROR_DUPLICATE_ATTR_NAME,   //�ظ���������
        XML_PARSE_ERROR_INVALID_ATTR_NAME,      //��Ч��������
